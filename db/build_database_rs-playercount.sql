...
--
-- Table structure for table `player_count`
--
...
CREATE TABLE `player_count` (
  ...
  `rs3` int(11) NOT NULL,
  `osrs` int(11) NOT NULL,
  `total` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=110698 DEFAULT CHARSET=utf8mb4;
...
-- Dump completed on 2021-12-01 11:06:08
